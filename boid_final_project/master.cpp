...
vector<Vector3f> run_master(int rank, int size)
{
	...
	vector<float> boid_memory(BOID_NUMBER * 2 * SYS_DIM); // pre-allocated contigous memory to de/serialise the boid data to for MPI communication
